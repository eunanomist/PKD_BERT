    ...
    if mode == 'race':
        ...
        if train_type == 'finetune_student':
            ...
            argv += [
                ...
                '--T', '20',
                '--teacher_prediction', f'/content/drive/My Drive/PKD/data/outputs/KD/{task_name}/{task_name}_normal_kd_teacher_12layer_result_summary.pkl',
            ]
            ...
            argv += [
                ...
                '--beta', '500',
                '--T', '10',
                '--teacher_prediction', f'/content/drive/My Drive/PKD/data/outputs/KD/{task_name}/{task_name}_patient_kd_teacher_12layer_result_summary.pkl',
                '--fc_layer_idx', '8,10',   # this for pkd-skip '1,3,5,7,9' # pkd-last '7,8,9,10,11'
